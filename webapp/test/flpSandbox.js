		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PraticaModel1",
									"targetURL": "#mentoriakafiorizpraticamodel1bfs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoriakafiorizpraticamodel1bfs-display": {
								"semanticObject": "mentoriakafiorizpraticamodel1bfs",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoria.ka.fiori.zpraticamodel1bfs",
									"url": sap.ui.require.toUrl("mentoria/ka/fiori/zpraticamodel1bfs")
								}
							}
						}
					}
